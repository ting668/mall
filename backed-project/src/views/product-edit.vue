        ...
        <div class="container">
          <div class="newproduct" v-for="(item,index) in newProducts" :key="index" :npIndex="index">
            ...
            <div class="newproduct-info">
              ...
              <div class="color">
                <div class="newproduct" v-for="(itemColor,colorIndex) in item.colorInfo" :key="colorIndex" >
                  <div class="newproduct-index">
                  ...
                  <div class="newproduct-info">
                    ...
                    <div class="size" >
                      ...
                      >
                        ...
                        <div class="newproduct-delete" @click="newProductSizeDelete(colorIndex,index)">
                          <i class="el-icon-delete"></i>
                        </div>
                      </div>
                      <div class="mg-TB60">
                        <el-button size="medium" round @click="newProductSizeAdd(colorIndex,index)">新增商品配置</el-button>
                      </div>
                    </div>
                  </div>
          ...
          <div class="mg-TB60">
            <el-button size="medium" round @click="newProductAdd()">新增商品</el-button>
            <el-button
              size="medium"
              type="primary"
              round
...
export default {
  ...
  methods: {
    ...
    newProductSizeDelete: function(colorIndex,index) {
      if (
        this.newProducts[this.npIndex].colorInfo[colorIndex].sizeInfo
          .length === 1
      ) {
        this.$toast.fail('至少保留一组商品数据！')
        return

  ...
  <div class="bg">
    ...
    <Content ref="scrollContent">
      <div class="content">
        ...
        <div class="count">
          <el-input placeholder="用户名称" v-model="username" @input="exitUser">
            ...
            <div class="input-suffix" slot="suffix">
              <i class="el-icon-circle-check" v-show="!existuser" style="color:green">
                <span>未注册</span>
              </i>
        ...
        <div class="count">
          <el-input type="password" placeholder="用于密码找回" v-model="email" show-password>
...
export default {
  ...
  methods: {
    ...
    exitUser: function() {
      const _this = this
      Axios.post('/admin/register/existuser', {
        username: _this.username
      })
        .then(function(res) {
          console.log(res.data)
